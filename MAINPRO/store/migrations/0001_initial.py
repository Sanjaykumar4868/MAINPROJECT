# Generated by Django 4.2.2 on 2023-08-11 08:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image4', models.ImageField(default='', upload_to='')),
                ('thumbnail', models.ImageField(blank=True, null=True, upload_to='uploads/product_images/thumbnail')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updates_at', models.DateTimeField(auto_now=True)),
                ('status', models.CharField(choices=[('draft', 'Draft'), ('waitingapproval', 'Wating approval'), ('active', 'Active'), ('deleted', 'Deleted')], default='active', max_length=50)),
